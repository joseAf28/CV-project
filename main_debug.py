...
if __name__ == "__main__":
    ...
    # len_each_target = []
    # for idx in idx_keys:
    #     len_each_target.append((len(track_coordinates[idx]), idx))
    ...
    color_one = colors[idx-1, :-1]*255
    print(color_one)
    
    track_coordinates_one = track_coordinates[idx][:, :-1]
    track_coordinates_one_img = src.coordinates2image(track_coordinates_one, card)
    
    track_coordinates_maps = src.warpPerspective2(track_coordinates_one_img, H, card2, color=color_one)
    
    imageio.imwrite(f'images/track_coordinates_maps_test_2.jpg', track_coordinates_maps)
    imageio.imwrite(f'images/track_coordinates_video_test_2.jpg', track_coordinates_one_img)
